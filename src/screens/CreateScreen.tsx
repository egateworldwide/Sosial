...
export default function CreateScreen({ email, team, onProfile, onConnect, onTemplate, onOpenProject, onComposePost }: {
  email: string;
  team: string;
  onProfile: () => void;
  onConnect: () => void;
...
const s = StyleSheet.create({
  ...
  cTitle: { fontFamily: 'PlusJakartaSans_800ExtraBold', fontSize: 15 },
